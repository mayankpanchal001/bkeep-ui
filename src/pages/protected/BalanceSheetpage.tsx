            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <div className="relative">
                        <button className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-primary bg-card border-2 border-primary/10 rounded hover:border-primary hover:bg-primary/10 transition-all">
                            <FaDownload />
                            Export
                        </button>
                    </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-end">
                    <div className="flex-1">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 border border-primary/10 rounded text-sm text-primary focus:outline-none focus:border-primary"
                        />
                    </div>
