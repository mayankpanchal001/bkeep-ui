            ...
            <div className="flex items-center justify-center h-full relative z-10 bg-transparent">
                ...
                <div className="absolute top-8 right-8 hidden lg:block">
                    <p className="text-[13px] font-medium text-gray-500 dark:text-gray-400">
                        ...
                        <Link
                            to="/login"
                            className="text-gray-900 white:text-white font-semibold hover:underline transition-all"
                        >
                            Login
                        </Link>
                    </p>
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="p-8 lg:p-12">
                        <div className="mb-6 text-center">
                            <h2 className="text-[24px] font-semibold leading-tight text-gray-900 white:text-white mb-1.5 tracking-tight">
                                Create Account
                            </h2>
