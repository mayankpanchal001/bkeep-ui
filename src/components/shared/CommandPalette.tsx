    ...
    return (
        <div className="fixed inset-0 z-100 flex items-start justify-center pt-[20vh] px-4">
            ...
            <div className="relative w-full max-w-lg bg-card rounded-xl  overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-200 border border-primary/10">
                            ...
                            {filteredCommands.map((cmd, index) => (
                                <button
                                    ...
                                    className={`
                                        ...
                                        ${index === selectedIndex ? 'bg-primary/10 text-primary' : 'text-primary/70 hover:bg-card'}
                                    `}
                ...
                {/* Footer */}
                <div className="px-4 py-2 bg-card border-t border-primary/10 flex items-center justify-between text-xs text-primary/40">
