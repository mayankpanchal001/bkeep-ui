...
const NotificationList = ({
    ...
    return (
        <>
            {/* Header - Only for Popover, Drawer has its own header */}
            {isPopover && (
            ...
            {/* Notifications List */}
            <ScrollArea className={isPopover ? 'max-h-80' : 'h-full'}>
                <div className="py-2">
                    {notifications.length === 0 ? (
                ...
                {isMobile ? (
                    ...
                    >
                        ...
                        <DrawerContent className="h-[85vh]">
                            <DrawerHeader className="text-left border-b border-sidebar-border">
