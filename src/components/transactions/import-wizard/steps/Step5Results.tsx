...
export function Step5Results() {
    const { state, pollImportProgress } = useImportWizard();
    ...
    return (
        <div className="space-y-6">
            ...
            {isSuccess && (
                <Alert className="border-green-200 bg-green-50">
                    ...
                    <AlertDescription className="text-green-700">
                        All {importResults.created} transactions were imported
                        successfully.
                    </AlertDescription>
                </Alert>
            )}
            ...
            {hasWarnings && (
                <Alert className="border-amber-200 bg-amber-50">
                    ...
                    <AlertDescription className="text-amber-700">
                        {importResults.created} transactions imported,{' '}
            ...
            {importResults.errors && importResults.errors.length > 0 && (
                <div className="space-y-3">
                    <h3 className="font-medium text-primary">Error Details</h3>
            ...
            {isSuccess && (
                <div className="text-center py-4">
                    <p className="text-sm text-muted-foreground">
                        Your transactions have been imported and are ready for
                        review in the Transactions section.
                    </p>
                </div>
            )}
        </div>
